...
static int parse_format (const char **format, int *width, int *precision) {
	char c;
	int r = 0;
...
static int valconv (unsigned long long val, char *buf, unsigned long long *sub, char *str) {
	int n = 0;
	int digit;
...
static int do_conversion_int (unsigned long long val, int f, int width, int precision, 
...
static int do_conversion_string (const char *str, int f, int width, int precision, 
		int (*func)(int c, void *data), void *data) {
	int len;
	int n = 0;
...
static int do_printf (const char *format, va_list ap, int (*func)(int c, void *data), void *data) {
	char c;
	int n, f;
	int width, precision;
...
static int do_putchar (int c, void *data) {
	putchar (c);
	return 0;
}

static int do_snputchar (int c, void *data) {
